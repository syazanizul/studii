                ...
                <table class="table mx-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(\App\PromoTracking::is_stage($m->id) == 0)
                                <form action="/admin/promo/stage">
                                    <input type="hidden" name="teacher_id" value="{{$m->id}}">
                                    <input type="hidden" name="stage" value="1">
                                    <input type="submit" value="Verify user profile is oay" class="btn btn-primary">
                                </form>
                                @elseif(\App\PromoTracking::is_stage($m->id) == 1)
                                <form action="/admin/promo/stage">
                                    <input type="hidden" name="teacher_id" value="{{$m->id}}">
                                ...
                                <form action="/admin/promo/stage">
                                    ...
                                    <input type="submit" value="Verify submitted 10 questions" class="btn btn-primary">
                                </form>
